...
#   
#     logit(SS[i,t])<-int[site[i],xage[i,t]]+(pente[site[i],xage[i,t]]*rel_hs2[i])
# 
# 
#   
...
# 
# inits <- function(){list(mean.phi= array(runif(4, 0, 1),dim=c(2,2)),pente=array(rnorm(64),dim=c(2,2)), r= runif(1, 0, 1),z = init.state)}  
# 
# #, lpsiA = rnorm(3), lpsiB = rnorm(3), lpsiC = rnorm(3), lpsiD = rnorm(3)
# 
# 
# # Parameters monitored
# parameters <-  c("mean.phi","int","pente", "psiA", "psiB", "psiC", "psiD", "r","p")
# 
# # MCMC settings
# ni <- 110000
# nt <- 100
